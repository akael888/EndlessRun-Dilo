...
public class TerrainGeneratorController : MonoBehaviour
{
    ...
    public float templateYSpawnFromCameraMiddle;
    ...
    public CharacterMoveController mainCharacter;
    ...
    private void GenerateTerrain(float posX, TerrainTemplateController forceterrain = null)
    {
        ...
        if (!mainCharacter.getTouchGroundOnce())
        {
            //spawn template 1 agar pemain tidak langsung jatuh ketika awal mulai game
            newTerrain = Instantiate(terrainTemplates[0].gameObject, transform);
        }
        else
        {
        ...
        newTerrain.transform.position = new Vector2(posX, gameCamera.transform.position.y + templateYSpawnFromCameraMiddle);
